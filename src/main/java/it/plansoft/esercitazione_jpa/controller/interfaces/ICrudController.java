package it.plansoft.esercitazione_jpa.controller.interfaces;/* ggrosso created on 21/02/2021 inside the package - it.plansoft.demojpa.controller.interfaces */
...
public interface ICrudController<DTO, ID> {
    ...
    /**
     * TODO: scrivi i commenti sui servizi REST
     * @param DTO
     * @return
     */
